      ...
      <main className='flex min-h-screen items-center justify-center'>
        <div className='pt-36 px-4  text-justify text-zinc-900'>
          ...
          <p>
            <span>
              Ao acessar o site{' '}
              <a href='https://www.sejahoop.com.br/'>Hoop Bank</a>, você
          ...
          <p>
            <span>
              ...
              materiais (informações ou software) no site Hoop Bank, apenas para
          ...
          <ol>
            ...
            <li>
              <span>
                ...
                software contido no site Hoop Bank;
              </span>
            </li>
            <li>
              <span>
          ...
          <p>
            <span>
              ...
              dessas restrições e poderá ser rescindida por Hoop Bank a qualquer
          ...
          <ol>
            <li>
              <span>
                Os materiais no site da Hoop Bank são fornecidos como estão.
                Hoop Bank não oferece garantias, expressas ou implícitas, e, por
            ...
            <li>
              <span>
                Além disso, o Hoop Bank não garante ou faz qualquer
          ...
          <p>
            <span>
              Em nenhum caso o Hoop Bank ou seus fornecedores serão responsáveis
              ​​por quaisquer danos (incluindo, sem limitação, danos por perda
              de dados ou lucro ou devido a interrupção dos negócios)
              decorrentes do uso ou da incapacidade de usar os materiais em Hoop
              Bank, mesmo que Hoop Bank ou um representante autorizado da Hoop
              Bank tenha sido notificado oralmente ou por escrito da
          ...
          <p>
            <span>
              Os materiais exibidos no site da Hoop Bank podem incluir erros
              técnicos, tipográficos ou fotográficos. Hoop Bank não garante que
              qualquer material em seu site seja preciso, completo ou atual.
              Hoop Bank pode fazer alterações nos materiais contidos em seu site
              a qualquer momento, sem aviso prévio. No entanto, Hoop Bank não se
          ...
          <p>
            <span>
              O Hoop Bank não analisou todos os sites vinculados ao seu site e
              não é responsável pelo conteúdo de nenhum site vinculado. A
              inclusão de qualquer link não implica endosso por Hoop Bank do
          ...
          <p>
            <span>
              O Hoop Bank pode revisar estes termos de serviço do site a
          ...
          <p>
            <span>
              ...
              as leis do Hoop Bank e você se submete irrevogavelmente à
