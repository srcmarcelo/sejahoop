...
const StorekeeperSection: React.FC = () => {
  return (
    <div
      ...
      className='flex bg-scroll bg-center bg-no-repeat bg-white justify-center items-end space-x-16 flex-1 max-h-165 mb-16 max-md:flex-col max-md:space-x-0 max-md:items-center max-md:max-h-none max-md:py-4 max-lg:mt-16'
    >
      <div className='flex flex-col justify-center items-center py-40 flex-1  h-full w-full px-10'>
        ...
        <button className='bg-primary hover:bg-white text-white hover:text-primary font-semibold py-2 px-4 border border-primary hover:border-primary rounded'>
          Conheça agora
        </button>
      </div>
    </div>
